...
class sfBaseMobileCarrierJP {
     ...
     * #test
     * <code>
     * #true(count(sfBaseMobileCarrierJP::getThirdforceJava()) > 0);
     * </code>
     */
    public static function getThirdforceJava() {
        return self::loadYaml("thirdforce-java");
    }
    /**
     * getDocomoJava()
     *
     * #test
     * <code>
     * #true(count(sfBaseMobileCarrierJP::getDocomoJava()) > 0);
     * </code>
     */
    public static function getDocomoJava() {
        return self::loadYaml("docomo-java");
    }
    /**
     * getThirdforceFlash()
     *
     * #test
     * <code>
     * #true(count(sfBaseMobileCarrierJP::getThirdforceFlash()) > 0);
     * </code>
     */
    public static function getThirdforceFlash() {
        return self::loadYaml("thirdforce-flash");
    }
    /**
     * getThirdforceDisplay()
     *
     * #test
     * <code>
     * #true(count(sfBaseMobileCarrierJP::getThirdforceDisplay()) > 0);
     * </code>
     */
    public static function getThirdforceDisplay() {
        return self::loadYaml("thirdforce-display");
    }
}
